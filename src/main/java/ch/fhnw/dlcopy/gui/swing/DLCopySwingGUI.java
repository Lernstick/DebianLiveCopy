...
public class DLCopySwingGUI extends JFrame
    ...
    public void checkAndInstallSelection(boolean interactive)
        ...
        new Installer(systemSource, installerPanels.getSelectedDevices(),
                ...
                installerPanels.isPersonalPasswordSelected(),
                installerPanels.getPersonalPassword(),
                installerPanels.isSecondaryPasswordSelected(),
                installerPanels.getSecondaryPassword(),
                installerPanels.isDuressPasswordSelected(),
                installerPanels.getDuressPassword(),
